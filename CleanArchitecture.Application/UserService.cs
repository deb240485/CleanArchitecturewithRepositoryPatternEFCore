...
namespace CleanArchitecture.Application
{
    public class UserService : IUserService
    {
        ...
        {
            var userFromDB = await _unitOfWork._userRepository.GetUsersByName(userName);
        ...
        public async Task<bool> Register(string userName, string password)
        {
            ...
            return await _unitOfWork._userRepository.CreateUser(userToDB);

        }

        public async Task<bool> UserAlreadyExists(string userName)
        {
            return await _unitOfWork._userRepository.UserAlreadyExists(userName);
        }
